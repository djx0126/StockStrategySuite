 ...
 *
 */
public class SLevel5HisTester extends AbstractStrategyStatisticData {
	 ...
	 */
	private static final String myStatisticType = Constant.SLevel5HisTester;
	...
	public DataArray actualGenerate(String stockCode, String statisticType,
		...
		try {
			...
			for (int i = 1 ; i<ma5.size();i++)
			{
				...
				HisDataType lastDayData = DateTester.getOneDayData(ma5.getDate(i-1));
				if (oneDayData!=null && lastDayData !=null){
