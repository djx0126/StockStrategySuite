...
public class Stestd_5 extends AbstractStrategyStatisticData {
	 ...
	 */
	private static String myStatisticType = Constant.Stestd_5;
	...
	public DataArray actualGenerate(String stockCode, String statisticType,
		...
		Map<String, Stestd_5.BreakData> buyData = new HashMap<>();
			...
			if (macd.getValue(i) > 0 && macd.getValue(i - 1) < 0  ) {
				...
				if (lastDeathCrossK > 0 && lastGoldenCross > 0 && !minorDeath && !minorGoldenCross) {
					if (i - lastGoldenCross <60 && i - lastGoldenCross > 12
						...
						DataArray indexMA60 = indexDataMap.getDataArray(Constant.MA250);
...
//				if (currentMax > 1.2d * currentData.buyPrice && close.getValue(i) < 0.9d * currentMax) {
//					toSell = true;
//				}
