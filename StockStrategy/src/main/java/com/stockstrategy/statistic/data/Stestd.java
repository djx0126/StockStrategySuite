...
public class Stestd extends AbstractStrategyStatisticData {
	 ...
	 */
	private static String myStatisticType = Constant.Stestd;
	...
	public DataArray actualGenerate(String stockCode, String statisticType,
		...
		Map<String, Stestd.BreakData> buyData = new HashMap<>();
...
//				if (currentMax > 1.1d * currentData.buyPrice && close.getValue(i) < 0.87d * currentMax) {
//					toSell = true;
//				}
